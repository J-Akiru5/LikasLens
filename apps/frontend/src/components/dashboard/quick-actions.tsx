        ...
        {actions.map((action, idx) => {
          ...
          return (
            <motion.button
              ...
              className={`w-full flex items-center gap-4 p-4 border-2 ${action.color} bg-background hover:bg-secondary/10 transition-all group rounded text-left text-foreground shadow-[2px_2px_0px_#1b4332] active:translate-y-[2px] active:shadow-none hover:shadow-[4px_4px_0px_#1b4332] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary`}
            >
