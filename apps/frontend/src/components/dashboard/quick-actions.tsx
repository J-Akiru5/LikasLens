    ...
    <div className="brutal-panel bg-white p-6 h-full">
      ...
      <div className="space-y-4">
        {actions.map((action, idx) => {
          ...
          return (
            <button key={idx} className="w-full flex items-center gap-4 p-4 border-2 border-primary hover:bg-primary hover:text-white transition-all group rounded text-left shadow-[2px_2px_0px_#1b4332] active:translate-y-[2px] active:shadow-none">
