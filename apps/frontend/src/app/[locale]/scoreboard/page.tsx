  ...
  if (error) {
    return (
      <DashboardLayoutWrapper>
        <ErrorPage message={error} onRetry={() => loadData(activeTab)} />
      </DashboardLayoutWrapper>
    );
  }
    ...
    <DashboardLayoutWrapper>
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          {spotlight && (
            <div className="lg:col-span-2 bg-gradient-to-br from-amber-500/15 via-amber-500/5 to-transparent border border-amber-500/20 rounded-3xl p-6 relative overflow-hidden">
          ...
          {/* Stats */}
          {stats && (
            <div className="bg-panel rounded-3xl border border-ink/5 p-6">
