...
export async function getDashboardStats() {
  ...
  return {
    ...
    data: {
      ...
      avg_response_sla: 1440,
      avg_response_progress: avgResponseMinutes > 0 ? Math.min(100, Math.round((1440 / avgResponseMinutes) * 100)) : 0,
      avg_response_trend: avgResponseMinutes <= 1440 ? "Within SLA" : "Over SLA",
      system_load: total,
