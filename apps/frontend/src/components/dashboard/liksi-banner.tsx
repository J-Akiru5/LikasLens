  ...
  return (
    <div className="mb-14 mt-24 sm:mt-36 px-4 sm:px-0 w-full">
      <div className="relative w-full">
        ...
        <div className="absolute bottom-[100%] mb-4 left-[100px] sm:left-[240px] z-40 max-w-[calc(100%-120px)] sm:max-w-none">
          <p className="text-[10px] sm:text-xs font-bold text-ink/40 tracking-widest uppercase mb-1 min-h-[15px]">
            {timeState.dateStr}
          </p>
          <h1 className="text-xl sm:text-[32px] font-medium tracking-tight text-ink m-0 leading-tight pr-2" style={{ letterSpacing: "-0.02em" }}>
            <span className="block sm:inline">{timeState.greeting}</span>{" "}
            <strong className="font-bold block sm:inline break-words sm:overflow-visible">{userName}!</strong>
          </h1>
        </div>
