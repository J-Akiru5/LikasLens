...
export function LoginClient() {
  ...
  return (
    <main className="min-h-dvh flex flex-col lg:flex-row bg-page selection:bg-accent/30 selection:text-current">
      {/* Left Panel: Immersive Nature Image with Trust Text (Hidden on small screens, 50% on large) */}
      ...
      {/* Right Panel: Clean, ultra-minimalist Form */}
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 lg:p-24 relative overflow-y-auto">
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-2xl border border-ink/20 bg-transparent hover:bg-ink/5 transition-colors text-ink font-medium font-heading tracking-wide disabled:opacity-50"
          >
            {isGoogleLoading ? (
