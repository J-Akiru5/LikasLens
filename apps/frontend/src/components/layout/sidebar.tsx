  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-1/2 -translate-y-1/2 left-4 z-50 p-3 min-w-[48px] min-h-[48px] brutal-panel border-2 border-primary rounded-lg shadow-[2px_2px_0px_#1b4332] hover:bg-primary/10 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-secondary"
      >
