          ...
          <div className="ios-grouped-list p-4">
            ...
            <div className="flex justify-center gap-4 mt-3 text-[10px] text-ink/50">
              <span className="flex items-center gap-1">
                <span className="w-2 h-2 rounded-full bg-[#22d3ee]" /> {t("phase1Live")}
              </span>
              <span className="flex items-center gap-1">
                <span className="w-2 h-2 rounded-full bg-[#34d399]" /> {t("phase2")}
              </span>
              <span className="flex items-center gap-1">
                <span className="w-2 h-2 rounded-full bg-gray-400" /> {t("planned")}
              </span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="ios-grouped-list p-4 flex flex-col gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] font-bold text-ink/40 uppercase tracking-wider leading-tight block">{t("totalReportsFiled")}</span>
              </div>
            </div>
            ...
            <div className="ios-grouped-list p-4 flex flex-col gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] font-bold text-ink/40 uppercase tracking-wider leading-tight block">{t("activeCitizens")}</span>
              </div>
            </div>
            ...
            <div className="ios-grouped-list p-4 flex flex-col gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] font-bold text-ink/40 uppercase tracking-wider leading-tight block">{t("regionsCovered")}</span>
              </div>
            </div>
            ...
            <div className="ios-grouped-list p-4 flex flex-col gap-3">
              ...
              <div>
                ...
                <span className="text-[10px] font-bold text-ink/40 uppercase tracking-wider leading-tight block">{t("casesResolved")}</span>
              </div>
            </div>
          </div>
        </RevealSection>
