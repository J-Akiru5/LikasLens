...
const TECH_NODES: TechNode[] = [
  ...
  },
  {
    ...
    sublabel: "Neo4j AuraDB",
    detail: "Neo4j-powered graph database mapping relationships between violations, locations, agencies, statutes, and temporal patterns. Enables multi-hop queries for pattern detection.",
    color: "#06b6d4",
    row: 1,
    col: 2,
  },
