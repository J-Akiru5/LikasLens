---
description: Global Monorepo Constitution for LikasLens. Enforces architectural boundaries, OpenAPI contracts, Ghost Mode security, and pnpm workspace rules. Loads for all tasks.
applyTo: '**/*'
---
